	...
	<body>
		<div id="container">
			...
			<section>
				...
				<h2>Vous serez redirigé vers la page de connexion lorsque vos changements seront validés.</h2>
				...
				<form id="form_profile" action="nvemail.php" method="POST">
					...
					<input id="bouton_form" type="submit" value="Changer d'email"><br/><br/>
				</form>
			</section>		
