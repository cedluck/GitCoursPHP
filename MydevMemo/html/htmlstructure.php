...
<html>
	...
	<body>	
		<div id="container">
			...
			<div>
				<div id="entete1">			
					<span><h1>HTML5: structure</h1></span><br/>
					<div id="flexDirRow">
					...
					<div id="navigation" style="border: 2px solid  #EF652A;">
						...
						<a href="htmlstructure.php" class="cat" style="background-color: #EF652A;">Structure</a>
						<a href="htmltableform.php"  class="cat">Table/Form</a>
					</div>
