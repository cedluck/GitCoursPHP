		...
		<div id="container">
			<nav style="margin-left: -180px;margin-top: 150px;">
				<h2>
					...
					<a href="enconstruction.php">chapitre suivant...</a>
					<a href="javascriptintro.php">chapitre précédent...</a>
			...
			<div id="entete1">			
				...
				<div id="navigation" style="border: 2px solid #F7DF1E;">
					<a href="javascriptintro.php" class="cat" >Intro >></a>
					<a href="javascriptpoo.php"  class="cat" style="background-color:#F7DF1E;">Poo >></a>
