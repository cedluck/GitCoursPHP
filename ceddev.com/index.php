	...
	<body>
		<div id="container">
			...
			<div id="central">								
				<nav>	
					<h3>Logiciel</h3>
					<a class="bouton_ver_nav" href="enconstruction.php">C++</a><br/>
					<a class="bouton_ver_nav" href="enconstruction.php">Qt</a>
					<h3>Web</h3>
					<a class="bouton_ver_nav" href="enconstruction.php">HTML 5</a><br/>
					<a class="bouton_ver_nav" href="enconstruction.php">CSS 3</a><br/>				
					<a class="bouton_ver_nav" href="javascriptIntro.php">JAVASCRIP</a><br/>
					<a class="bouton_ver_nav" href="enconstruction.php">PHP MySQL</a><br/>				
				</nav>
				<section>										
					<article>
					<h3>POURQUOI FAIRE UN SITE ?</h3>
						<p>
						Bon déjà j'adore coder donc bah... j'ai coder un site.<br/><br/>
